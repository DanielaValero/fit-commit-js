 ...
 * @param  {String} validator  Optional parameter. If defined will check if a given validator has an error
...
module.exports = {
  ...
  // For testing
  clearErrorsMap: clearErrorsMap,
  getErrorsMapEntry: getErrorsMapEntry,
};
